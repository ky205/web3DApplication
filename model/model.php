            ...
            try{
                $this->dbhandle->exec(
                    "INSERT INTO Model_3D(title,subtitle, descrip, imglink1,imglink2,imglink3,imglink4,x3dlink)
                        VALUES ('Pepsi','string_2','Pepsi is a carbonated soft drind manufactured by PepsiCo. Originally crated ande developed in 1983 by Caleb Bardham, it was renamed as Pepsi-Cola in 1898','pesiFront','pesiBot','pesiBack','pesiTop','string_8');".
                    
                    "INSERT INTO Model_3D(title,subtitle, descrip, imglink1,imglink2,imglink3,imglink4,x3dlink)
                        VALUES ('Cola Glass','string_2','Coca-Cola, or Coke, is a carbonated soft drink manufactured by The Coca-Cola Company. Originally marketed as a temperance drink and intended as a patent medicine, it was invented in the late 19th century by John Stith Pemberton.','colaPlateFront','colaPlateBot','colaPlateBack','colaPlateTop','string_8');".
